...
/* package Vaxk-0.1.0.0 */
#ifndef VERSION_Vaxk
#define VERSION_Vaxk "0.1.0.0"
#endif /* VERSION_Vaxk */
#ifndef MIN_VERSION_Vaxk
#define MIN_VERSION_Vaxk(major1,major2,minor) (\
  (major1) <  0 || \
  (major1) == 0 && (major2) <  1 || \
  (major1) == 0 && (major2) == 1 && (minor) <= 0)
#endif /* MIN_VERSION_Vaxk */
...
#define CURRENT_COMPONENT_ID "Vaxk-0.1.0.0-inplace-Vaxk"
